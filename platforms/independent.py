...
PLONE_CORE = [
    ...
    ZProduct('CMFPlacefulWorkflow', PLONE_ORG + 'cmfplacefulworkflow/releases/1.3.0rc3/cmfplacefulworkflow-1-3-0rc3.tgz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4../kupu-1-4-9.tgz'),
