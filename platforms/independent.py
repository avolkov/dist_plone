...
PLONE_CORE = [
    ...
    ZProduct('ATContentTypes', PLONE_ORG + 'atcontenttypes/releases/1.2.1/ATContentTypes-1.2.1-2.tgz'),
    ...
    ZProduct('PluggableAuthService', ZOPE_ORG + 'PluggableAuthService/PluggableAuthService-1.5/PluggableAuthService-1.5.1.tar.gz', 'PluggableAuthService-1.5.1'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.contentrules', CHEESE_SOURCE + 'p/plone.app.contentrules/plone.app.contentrules-1.0.1.1tar.gz', version="1.0.1.1"),
    ...
    PyModule('plone.contentrules', CHEESE_SOURCE + 'p/plone.contentrules/plone.contentrules-1.0..1.1tar.gz', version="1.0.1.1"),
...
AT1_5 = [
    ZProduct('Archetypes', PLONE_ORG + 'archetypes/releases/1.5/Archetypes-1.5.1.tar.gz'),
]
