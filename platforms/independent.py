...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_BASE + 'PloneBase-2.1.3-rc1.tar.gz'),
    ...
    ZProduct('PloneTranslations', PLONE_ORG + 'plonetranslations/releases/2.1.3/PloneTranslations-2.1.3.tar.gz'),
