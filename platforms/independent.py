...
PLONE_CORE = [
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4/kupu-1-4.tgz'),
    ...
    ZProduct('PloneTranslations',PLONE_ORG + 'plonetranslations/releases/3.0.3/PloneTranslations-3.0.3.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.linkintegrity', PLONE_DIST + 'plone.app.linkintegrity-1.0.tar.gz', version="1.0"),
    PyModule('plone.app.openid', CHEESE_SOURCE + 'p/plone.app.openid/plone.app.openid-1.0.tar.gz', version="1.0"),
    ...
    PyModule('plone.app.vocabularies', CHEESE_SOURCE + 'p/plone.app.vocabularies/plone.app.vocabularies-1.0.tar.gz', version="1.0"),
