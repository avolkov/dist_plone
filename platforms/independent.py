...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('borg.localrole', CHEESE_SOURCE + 'b/borg.localrole/borg.localrole-2.0.tar.gz', version="2.0"),
    ...
    PyModule('plone.browserlayer', CHEESE_SOURCE + 'p/plone.browserlayer/plone.browserlayer-1.0.tar.gz', version="1.0"),
