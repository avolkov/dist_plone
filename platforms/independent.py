...
PLONE_CORE = [
    ...
    ZProduct('PlonePAS', PLONE_ORG + 'plonepas/releases/3.0/PlonePAS-3.0-beta3.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.openid', CHEESE_SOURCE + 'p/plone.app.openid/plone.app.openid-1.0b1.tar.gz'),
    ...
    PyModule('plone.openid', CHEESE_SOURCE + 'p/plone.openid/plone.openid-1.0b2.tar.gz'),
