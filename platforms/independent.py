...
PLONE_CORE = [
    ...
    ZProduct('ATContentTypes', PLONE_ORG + 'atcontenttypes/releases/1.0.2/ATContentTypes-1.0.2.tar.gz'),
...
AT1_3 = [
    ZProduct('Archetypes', PLONE_ORG + 'archetypes/releases/1.3.6-RC1/archetypes-1-3-6-rc1-bundle-tar.gz'),
]
