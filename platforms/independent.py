...
PLONE_CORE = [
    ...
    ZProduct('PlacelessTranslationService',  PLONE_ORG + 'pts/releases/1.4.7/PlacelessTranslationService-1.4.7.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.contentmenu', CHEESE_SOURCE + 'p/plone.app.contentmenu/plone.app.contentmenu-1.0.5.tar.gz', version="1.0.5"),
