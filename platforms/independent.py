...
#             'GenericSetup' : ZProduct,
    ...
    ZProduct('PloneTranslations',PLONE_ORG + 'plonetranslations/releases/3.0.3/PloneTranslations-3.0.3rc2.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.controlpanel', CHEESE_SOURCE + 'p/plone.app.controlpanel/plone.app.controlpanel-1.0rc2.tar.gz', version="1.0rc2"),
    ...
    PyModule('plone.app.linkintegrity', CHEESE_SOURCE + 'p/plone.app.linkintegrity/plone.app.linkintegrity-1.0rc2.tar.gz', version="1.0rc2"),
    ...
    PyModule('plone.app.vocabularies', CHEESE_SOURCE + 'p/plone.app.vocabularies/plone.app.vocabularies-1.0rc2.tar.gz', version="1.0rc2"),
    ...
    PyModule('plone.fieldsets', CHEESE_SOURCE + 'p/plone.fieldsets/plone.fieldsets-1.0rc2.tar.gz', version="1.0rc2"),
