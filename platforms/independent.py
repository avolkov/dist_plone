...
PLONE_CORE = [
    ...
    ZProduct('ATContentTypes', PLONE_ORG + 'atcontenttypes/releases/1.1.7/ATContentTypes-1.1.7-final.tgz'),
    ...
    ZProduct('CMFPlone', PLONE_BASE + 'PloneBase-2.5.4-final.tar.gz'),
    ...
    ZProduct('PloneTranslations',PLONE_ORG + 'plonetranslations/releases/3.0.6/PloneTranslations-3.0.6.tar.gz'),
