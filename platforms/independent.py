...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.1.2.tar.gz'),
    ZProduct('CMFQuickInstallerTool', PLONE_ORG + 'cmfquickinstallertool/releases/2.1.5/CMFQuickInstallerTool-2.1.5.tar.gz'),
    ...
    ZProduct('PloneTranslations', PLONE_ORG + 'plonetranslations/releases/3.1.2/PloneTranslations-3.1.2.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.portlets', CHEESE_SOURCE + 'p/plone.app.portlets/plone.app.portlets-1.1.2.tar.gz', version="1.1.2"),
    ...
    PyModule('plone.portlet.collection', CHEESE_SOURCE + 'p/plone.portlet.collection/plone.portlet.collection-1.1.2.tar.gz', version="1.1.2"),
