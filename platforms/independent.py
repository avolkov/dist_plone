...
#    ZProduct('CMFPlone', PLONE_BASE + 'PloneBase-3.0-alpha2.tar.gz'),
    ZProduct('CMFPlone', '/local/PLONERELEASE/PloneBase-3.0-alpha2.tar.gz'),
    ...
    ZProduct('PloneTestCase',PLONE_ORG + 'plonetestcase/releases/0.9.2/PloneTestCase-0.9.2.tar.gz'),
    ...
    ZProduct('ResourceRegistries', PLONE_ORG + 'resourceregistries/releases/1.4.0-alpha2/ResourceRegistries-1.4.0-alpha2.tgz'),
